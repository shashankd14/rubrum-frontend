...
function* fetchRatesList(action) {
  try {
    ...
    } else yield put(fetchRatesListError('error'));
  } catch (error) {
...
function* fetchPackingRatesList() {
  try {
    ...
    if (fetchPackingRatesList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchPackingRatesListError('error'));
  } catch (error) {
...
function* savePriceMaster(action) {
  ...
  try {
    ...
    if (addRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(addRatesError('error'));
  } catch (error) {
...
function* addPackingRates(action) {
  try {
    ...
    if (addPackingRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(addPackingRatesError('error'));
  } catch (error) {
...
function* updateRates(action) {
  ...
  try {
    ...
    if (updateRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateRatesError('error'));
  } catch (error) {
...
function* updatePackingRates(action) {
  try {
    ...
    const updatePackingRates = yield fetch(
      `${baseUrl}api/packing/rate/update`,
      {
        method: 'PUT',
        body: JSON.stringify(data),
        headers: { 'Content-Type': 'application/json', ...getHeaders() },
    ...
    if (updatePackingRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updatePackingRatesError('error'));
  } catch (error) {
...
function* fetchRatesListById(action) {
  try {
    const fetchRatesById = yield fetch(
      `${baseUrl}api/pricemaster/${action.rateId}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchRatesById.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchRatesListByIdError('error'));
  } catch (error) {
...
function* fetchPackingRatesById(action) {
  try {
    const fetchPackingRatesById = yield fetch(
      `${baseUrl}api/packing/rate/${action.packingRatesId}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchPackingRatesById.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchPackingRatesByIdError('error'));
  } catch (error) {
...
function* deleteRatesById(action) {
  try {
    const deletedRates = yield fetch(
      `${baseUrl}api/pricemaster/${action?.payload}`,
      {
        method: 'DELETE',
        headers: getHeaders(),
      },
    ...
    if (deletedRates.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteRatesError('error'));
  } catch (error) {
...
function* saveAdditionalPriceMaster(action) {
  try {
    const addAdditionalRates = yield fetch(
      `${baseUrl}api/additionalprice/save`,
      {
        method: 'POST',
    ...
    if (addAdditionalRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(addAdditionalRatesError('error'));
  } catch (error) {
...
function* getStaticAdditionalRatesByProcess(action) {
  try {
    const getStaticList = yield fetch(
      `${baseUrl}api/additionalprice/pocess/${action.processId}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (getStaticList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getStaticListError('error'));
  } catch (error) {
...
function* fetchAdditionalPriceList() {
  try {
    ...
    if (fetchRatesList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchAdditionalRatesListError('error'));
  } catch (error) {
...
function* fetchAdditionalPriceListById(action) {
  try {
    const fetchRatesById = yield fetch(
      `${baseUrl}api/additionalprice/${action.rateId}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchRatesById.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchAdditionalPriceListByIdError('error'));
  } catch (error) {
...
function* deleteAdditionalRatesById(action) {
  try {
    const deletedRates = yield fetch(
      `${baseUrl}api/additionalprice/${action?.payload}`,
      {
        method: 'DELETE',
        headers: getHeaders(),
      },
    ...
    if (deletedRates.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteAdditionalRatesError('error'));
  } catch (error) {
...
function* updateAdditionalRates(action) {
  try {
    ...
    if (updateRates.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateAdditionalRatesError('error'));
  } catch (error) {
...
function* fetchLaminationChargesList() {
  try {
    ...
    if (fetchLaminationChargesList.status === 200) {
      const fetchLaminationChargesListResponse =
        yield fetchLaminationChargesList.json();
      yield put(
        getLaminationChargesListSuccess(fetchLaminationChargesListResponse),
      );
    } else if (fetchLaminationChargesList.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(getLaminationChargesListError('error'));
  } catch (error) {
...
function* fetchLaminationChargesById(action) {
  try {
    const fetchLaminationChargesById = yield fetch(
      `${baseUrl}api/lamination/${action.laminationId}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchLaminationChargesById.status === 200) {
      const fetchLaminationChargesByIdResponse =
        yield fetchLaminationChargesById.json();
      yield put(
        getLaminationChargesByIdSuccess(fetchLaminationChargesByIdResponse),
      );
    } else if (fetchLaminationChargesById.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(getLaminationChargesByIdError('error'));
  } catch (error) {
...
function* addLaminationCharges(action) {
  try {
    ...
    if (addLaminationCharges.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(addLminationChargesError('error'));
  } catch (error) {
...
function* updateLaminationCharges(action) {
  try {
    ...
    const updateLaminationCharges = yield fetch(
      `${baseUrl}api/lamination/update`,
      {
        method: 'PUT',
        body: JSON.stringify([data]),
        headers: { 'Content-Type': 'application/json', ...getHeaders() },
    ...
    if (updateLaminationCharges.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateLminationChargesError('error'));
  } catch (error) {
...
function* deleteLaminationCharges(action) {
  try {
    const deletedLaminationCharges = yield fetch(
      `${baseUrl}api/lamination/${action?.payload}`,
      {
        method: 'DELETE',
        headers: getHeaders(),
      },
    ...
    if (deletedLaminationCharges.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteLminationChargesError('error'));
  } catch (error) {
...
function* fetchLaminationChargesByPartyId(action) {
  try {
    const fetchLaminationChargesById = yield fetch(
      `${baseUrl}api/lamination/party/${action.partyId[0]}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchLaminationChargesById.status === 200) {
      ...
      yield put(
        getLaminationChargesByPartyIdSuccess(
          fetchLaminationChargesByIdResponse,
        ),
      );
    } else if (fetchLaminationChargesById.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(getLaminationChargesByPartyIdError('error'));
  } catch (error) {
...
function* fetchLaminationChargesDropDownList() {
  try {
    const fetchLaminationChargesList = yield fetch(
      `${baseUrl}api/lamination/getLaminationChargesList`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchLaminationChargesList.status === 200) {
      const fetchLaminationChargesListResponse =
        yield fetchLaminationChargesList.json();
      yield put(
        getLaminationChargesDropDownSuccess(fetchLaminationChargesListResponse),
      );
    } else if (fetchLaminationChargesList.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(getLaminationChargesDropDownError('error'));
  } catch (error) {
...
export function* watchFetchRequests() {
  ...
  yield takeLatest(
    FETCH_STATIC_LIST_BY_PROCESSS,
    getStaticAdditionalRatesByProcess,
  );
  yield takeLatest(
    FETCH_ADDITIONAL_RATES_LIST_REQUEST,
  ...
  yield takeLatest(
    GET_LAMINATION_CHARGES_LIST_REQUEST,
    fetchLaminationChargesList,
  );
  yield takeLatest(
    GET_BY_ID_LAMINATION_CHARGES_REQUEST,
    fetchLaminationChargesById,
  );
  ...
  yield takeLatest(
    GET_BY_PARTY_ID_LAMINATION_CHARGES_REQUEST,
    fetchLaminationChargesByPartyId,
  );
  yield takeLatest(
    GET_LAMINATION_CHARGES_DROPDOWN_REQUEST,
    fetchLaminationChargesDropDownList,
  );
}
