...
function* fetchYLRList(action) {
  ...
  try {
    ...
    } else yield put(fetchYLRListError('error'));
  } catch (error) {
...
function* fetchYLRById(action) {
  ...
  try {
    ...
    if (fetchYlrId.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchYLRbyIdError('error'));
  } catch (error) {
...
function* addYLRsaga(action) {
  try {
    ...
    if (addParty.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(addYLRError('error'));
  } catch (error) {
...
function* updateYLRsaga(action) {
  try {
    ...
    if (updateYLR.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateYLRError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteYLRById(action) {
  ...
  try {
    ...
    if (deletedYLR.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteYLRError('error'));
  } catch (error) {
