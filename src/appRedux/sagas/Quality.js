...
function* saveTemplate(action) {
  try {
    ...
    } else yield put(saveTemplateError('error'));
  } catch (error) {
...
function* saveQualityTemplate(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(
        saveQualityTemplateSuccess(qualityTemplateResponse.inwardEntryId),
      );
    } else if (qualityTemplate.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(saveQualityTemplateError('error'));
  } catch (error) {
    console.log(error);
...
function* getQualityTemplateById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/template/${data.payload}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getQualityTemplateByIdError('error'));
  } catch (error) {
    console.log(error);
...
function* fetchTemplateList(action) {
  try {
    ...
    if (fetchTemplateList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchTemplatesListError('error'));
  } catch (error) {
...
function* updateQualityTemplateById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/template/update`,
      {
        method: 'PUT',
        body: data.payload,
        headers: getHeaders(),
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateQualityTemplateError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteQualityTemplateById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteQualityTemplateError('error'));
  } catch (error) {
    console.log(error);
...
function* saveQualityTemplateLink(data) {
  try {
    ...
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/templatemap/save`,
      {
        method: 'POST',
        body: data.payload,
        headers: { 'Content-Type': 'application/json', ...getHeaders() },
    ...
    if (qualityTemplate.status == 200) {
      let qualityTemplateResponse = yield qualityTemplate.json();
      yield put(
        saveQualityTemplateLinkSuccess(qualityTemplateResponse.inwardEntryId),
      );
    } else if (qualityTemplate.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(saveQualityTemplateLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* getQualityTemplateLinkById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/templatemap/${data.payload}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getQualityTemplateLinkByIdError('error'));
  } catch (error) {
    console.log(error);
...
function* fetchTemplateLinkList(payload) {
  try {
    const reqUrl =
      payload && payload.params && payload.params.partyId
        ? `${baseUrl}api/quality/templatemap/party/${payload.params.partyId}`
        : `${baseUrl}api/quality/templatemap`;
    ...
    if (fetchTemplateList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchTemplatesLinkListError('error'));
  } catch (error) {
...
function* updateQualityTemplateLinkById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateQualityTemplateLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* fetchQualityReportStageList(req) {
  ...
  try {
    const endP =
      req.payload.stage.includes('processing') ||
      req.payload.stage.includes('inward')
        ? 'listpage'
        : 'listpage';
    ...
    if (fetchQRList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchQualityReportStageListError('error'));
  } catch (error) {
...
function* fetchQualityReportStageList1(req) {
  ...
  try {
    ...
    const endPoint =
      req.payload.stage === 'inwardlist'
        ? '/api/quality/reports/inwardlist/1/1'
        : req.payload.stage === 'preprocessing'
          ? '/api/quality/qir/fetchpacketdtls'
          : req.payload.stage === 'processing'
            ? '/api/quality/qir/fetchpacketdtls'
            : req.payload.stage === 'predispatch'
              ? '/api/quality/qir/dispatchlist'
              : '/api/quality/qir/dispatchlist';
    const methodType =
      req.payload.stage === 'inwardlist'
        ? 'GET'
...
function* saveQualityReport(data) {
  ...
  try {
    ...
    if (qualityTemplate.status == 200) {
      let qualityTemplateResponse = yield qualityTemplate.json();
      yield put(
        saveQualityReportSuccess(qualityTemplateResponse.inwardEntryId),
      );
    } else if (qualityTemplate.status === 401) {
      yield put(userSignOutSuccess());
    } else yield put(saveQualityReportError('error'));
  } catch (error) {
    console.log(error);
...
function* getQualityReportById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/qir/${data.payload}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getQualityReportByIdError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteQualityReportById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteQualityReportError('error'));
  } catch (error) {
    console.log(error);
...
function* fetchKqpList(action) {
  try {
    ...
    if (fetchQRList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchKqpListError('error'));
  } catch (error) {
...
function* saveKqp(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(saveKqpError('error'));
  } catch (error) {
    console.log(error);
...
function* getKqpById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/kqp/${data.payload}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getKqpByIdError('error'));
  } catch (error) {
    console.log(error);
...
function* updateKqpById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateKqpError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteKqpById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteKqpError('error'));
  } catch (error) {
    console.log(error);
...
function* fetchKqpLinkList(action) {
  try {
    ...
    if (fetchQRList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(fetchKqpLinkListError('error'));
  } catch (error) {
...
function* saveKqpLink(data) {
  try {
    ...
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/kqppartymap/save`,
      {
        method: 'POST',
        body: data.payload,
        // headers: {'Content-Type': 'multipart/form-data', ...getHeaders()}
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(saveKqpLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* getKqpLinkById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/kqppartymap/${data.payload}`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getKqpLinkByIdError('error'));
  } catch (error) {
    console.log(error);
...
function* updateKqpLinkById(data) {
  try {
    // let data = new FormData();
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/kqppartymap/update`,
      {
        method: 'PUT',
        body: data.payload,
        headers: getHeaders(),
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(updateKqpLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteKqpLinkById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteKqpLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* deleteQualityTemplateLinkById(data) {
  try {
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(deleteQualityTemplateLinkError('error'));
  } catch (error) {
    console.log(error);
...
function* getThicknessList(action) {
  try {
    const fetchThicknessList = yield fetch(
      `${baseUrl}api/quality/templatemap/getallthickness`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchThicknessList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getThicknessListQMError('error'));
  } catch (error) {
...
function* getWidthList(action) {
  try {
    const fetchWidthList = yield fetch(
      `${baseUrl}api/quality/templatemap/getallwidth`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchWidthList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getWidthListQMError('error'));
  } catch (error) {
...
function* getLengthList(action) {
  try {
    const fetchLengthList = yield fetch(
      `${baseUrl}api/quality/templatemap/getalllength`,
      {
        method: 'GET',
        headers: getHeaders(),
      },
    ...
    if (fetchLengthList.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getLengthListQMError('error'));
  } catch (error) {
...
function* getPacketDetailsQuality(data) {
  try {
    const qualityTemplate = yield fetch(
      `${baseUrl}api/quality/qir/fetchpacketdtls`,
      {
        method: 'POST',
        body: data.payload,
        headers: { 'Content-Type': 'application/json', ...getHeaders() },
    ...
    if (qualityTemplate.status == 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(getQualityPacketDetailsError('error'));
  } catch (error) {
    console.log(error);
  ...
  try {
    if (action.payload.type === 'inward') {
      ...
      if (pdfGenerate.status === 200) {
        ...
        if (
          pdfGenerateResponse.dc_pdfs &&
          pdfGenerateResponse.dc_pdfs.length > 0
        ) {
      ...
      pdfGenerate = yield fetch(
        `${baseUrl}api/pdf/qirpdf/${action.payload.qirId}`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
    ...
    if (pdfGenerate.status === 200) {
      ...
      yield put(userSignOutSuccess());
    } else yield put(pdfGenerateQMreportInwardError('error'));
  } catch (error) {
...
export function* watchFetchRequests() {
  ...
  yield takeLatest(
    DELETE_QUALITY_TEMPLATE_LINK_REQUEST,
    deleteQualityTemplateLinkById,
  );
  yield takeLatest(
    GET_PACKET_DETAILS_QUALITY_PROCESS_REQUEST,
    getPacketDetailsQuality,
  );
  yield takeLatest(
    GENERATE_INWARD_PDF_QUALITY_MODULE_REPORT_REQUEST,
    generateQMreportInwardPdf,
  );
}
