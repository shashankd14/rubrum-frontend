...
const CreateForm = (props) => {
  ...
  useEffect(() => {
    if (
      props.inward.inwardEntry &&
      (props.match.params.inwardEntryId === "" ||
        props.match.params.inwardEntryId === undefined)
    ) {
  ...
  return (
    <>
      <SyncToZohoModal
        ...
        poInvoiceNumber={props.inwardForm.customerInvoiceNo}
      />
      <Card
        className="gx-card"
        title="Inward Entry"
  ...
  mapPropsToFields(props) {
    return {
      partyName: Form.createFormField({
        ...
        value:
          ...
          props.inward.inward.party
            ? props.inward.inward.party.partyName
            : props.inward.inward.partyName
            ? props.inward.inward.partyName
            : "",
      }),
      ...
      thickness: Form.createFormField({
        ...
        value: props.match.params
          ? props.inward.inward.fThickness
          : props.inward.inward.thickness
          ? props.inward.inward.thickness
          : "",
      }),
