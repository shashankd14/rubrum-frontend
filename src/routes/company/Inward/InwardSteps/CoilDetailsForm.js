    ...
    props.form.validateFields(err => {
      if (!err) {
        let length =
          props.params !== ''
            ? parseFloat(
                parseFloat(props.inward.fpresent) /
                  (parseFloat(props.inward.fThickness) *
                    7.85 *
                    (props.inward.fWidth / 1000)),
              ).toFixed(4) * 1000
            : parseFloat(
      ...
      <Col span={14}>
        ...
        >
          <Form.Item
            ...
            help={
              props.inwardStatus.loading
                ? 'We are checking if the coil number already exists'
                : !props.inwardStatus.loading &&
                    props.inwardStatus.success &&
                    props.inwardStatus.duplicateCoil
                  ? 'The coil number already exists'
                  : ''
            }
          >
            {getFieldDecorator('coilNumber', {
              rules: [
                { required: true, message: 'Please input the coil number!' },
              ...
              <Input
                ...
                onBlur={
                  props.params !== ''
                    ? ''
                    : e => props.checkIfCoilExists(e.target.value)
                }
              />,
            )}
          </Form.Item>
          <Form.Item label="Material Description">
            {getFieldDecorator('description', {
              rules: [
                {
                  required: true,
                  message: 'Please input the material description!',
                },
              ],
            })(
              <AutoComplete
                ...
                onChange={
                  props.params !== ''
                    ? e => handleChange(e, 'material.description')
                    : ''
                }
                filterOption={(inputValue, option) => {
                  return (
                    option.props.children
                      ?.toUpperCase()
                      .indexOf(inputValue.toUpperCase()) !== -1 || false
                  );
                }}
              />,
            )}
          ...
          <Form.Item label="Coil Width (in mm)">
            {getFieldDecorator('width', {
              rules: [
                { required: true, message: 'Please input the coil width!' },
              ],
            })(
              <Input
                id="coilWidth"
                onChange={
                  props.params !== '' ? e => handleChange(e, 'fWidth') : ''
                }
              />,
            )}
          </Form.Item>
          <Form.Item label="Coil Thickness (in mm)">
            {getFieldDecorator('thickness', {
              rules: [
                { required: true, message: 'Please input the coil thickness!' },
              ],
            })(
              <Input
                id="coilThickness"
                onChange={
                  props.params !== '' ? e => handleChange(e, 'fThickness') : ''
                }
              />,
            )}
          </Form.Item>
          <Form.Item label="Net Weight (in kgs)">
            {getFieldDecorator('netWeight', {
              rules: [
                {
                  required: true,
                  message: 'Please input the coil net weight!',
                },
              ],
            })(
              <Input
                id="coilNetWeight"
                onChange={
                  props.params !== '' ? e => handleChange(e, 'fpresent') : ''
                }
              />,
            )}
          </Form.Item>
          <Form.Item label="Gross Weight (in kgs)">
            {getFieldDecorator('grossWeight', {
              rules: [
                {
                  required: true,
                  message: 'Please input the coil gross weight!',
                },
              ],
            })(
              <Input
                id="coilGrossWeight"
                onChange={
                  props.params !== '' ? e => handleChange(e, 'fQuantity') : ''
                }
              />,
            )}
          </Form.Item>
          <Form.Item label="Coil Length (in mts)">
            {getFieldDecorator('approxLength', {
              rules: [
                { required: false, message: 'Please input the coil number!' },
              ],
            })(
              <>
                <Input
                  id="coilLength"
                  value={
                    props.params !== '' ? props.inward.fLength : approxLength
                  }
                  name="approxLength"
                />
                Approx
