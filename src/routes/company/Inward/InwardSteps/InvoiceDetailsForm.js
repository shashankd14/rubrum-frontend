  ...
  mapPropsToFields(props) {
    return {
      receivedDate: Form.createFormField({
        ...
        value: moment(
          props.inward.receivedDate ||
            moment(props.inward.dReceivedDate) ||
            new Date(),
          APPLICATION_DATE_FORMAT
        ),
      }),
      ...
      invoiceDate: Form.createFormField({
        ...
        value: props.inward.invoiceDate
          ? moment(props.inward.invoiceDate, APPLICATION_DATE_FORMAT)
          : props.inward.dInvoiceDate
          ? moment(props.inward.dInvoiceDate, APPLICATION_DATE_FORMAT)
          : null,
      }),
    };
  },
