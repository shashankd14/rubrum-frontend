            ...
            <Row>
              ...
              <Col span={12}>
                <Card title="Inward Details" style={{ width: 300 }}>
                  ...
                  <p>
                    Dimensions :{" "}
                    {inwardEntryId !== undefined ? dimensionEdit : dimension}
                  </p>
                  <p>
                    Net Weight :{" "}
                    {props.params !== ""
            ...
            <Row>
              <Col span={12}>
                <Card title="Invoice Details" style={{ width: 300 }}>
                  <p>
                    Received Date :
                    {moment(props.inward.receivedDate).format(
              ...
              <Col span={12}>
                <Card title="Quality Details" style={{ width: 300 }}>
                  ...
                  {props.inward.testFile && (
                    <p>Test File : {props.inward.testFile.fileList[0].name}</p>
                  )}
                  {props.inward.invoiceCopy && (
                    <p>
                      Invoice copy : {props.inward.invoiceCopy.fileList[0].name}
                    </p>
                  )}
