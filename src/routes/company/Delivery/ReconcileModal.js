...
const ReconcileModal = props => {
  ...
  return (
    <Modal visible={props.showModal} width={1020}>
              ...
              <Form {...formItemLayout} className="login-form gx-pt-4">
                <Form.Item label="Date">
                  {getFieldDecorator('date', {
                    initialValue: moment(
                      new Date(props.deliveryRecord.deliveryDetails.updatedOn),
                    ...
                    <>
                      <DatePicker
                        ...
                        defaultValue={moment(
                          new Date(
                            props.deliveryRecord.deliveryDetails.updatedOn,
                          ),
                          APPLICATION_DATE_FORMAT,
                        )}
                  ...
                  {getFieldDecorator('vehicleNo', {
                    ...
                    <>
                      <Input
                        id="vehicleNo"
                        disabled={true}
                        value={props.deliveryRecord.deliveryDetails.vehicleNo}
                        name="vehicleNo"
                      />
                    </>,
                  )}
                ...
                <Form.Item label="Weigh Bridge Name">
                  {getFieldDecorator('bridgeName')(<Input id="bridgeName" />)}
                </Form.Item>
                ...
                <Form.Item label="Net Weight(kg)">
                  {getFieldDecorator('netWeight')(<Input id="netWeight" />)}
                </Form.Item>
