...
const Company = ({match}) => (
    <Switch>
        ...
        <Route path={`${match.url}/inwardDV`} component={asyncComponent(() => import('./InwardDV'))}/> 
        <Route path={`${match.url}/stockRegister`} component={asyncComponent(() => import('./StockRegister'))}/>
    </Switch>
);
