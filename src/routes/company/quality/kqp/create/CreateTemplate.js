...
const CreateTemplate = props => {
  ...
  useEffect(() => {
    if (
      ...
      props.templateDetails.operation === 'kqpById'
    ) {
  ...
  const handleCreate = data => {
    ...
    if (action === 'create') props.saveKqp(JSON.stringify(request));
    else if (action === 'edit') {
          ...
          <div className="gx-w-50">
            ...
            <div className="table-operations gx-col">
              <Row>
                ...
                />
                {kqpNameErr && (
                  <p style={{ color: 'red' }}>Please enter KQP Name</p>
                )}
              </Row>
            </div>
          </div>
              ...
              <Row>
                <div style={{ marginTop: 45 }}>
                  <Button
                    style={{ marginLeft: 8 }}
                    disabled={isDisabled}
                    onClick={() => props.history.push('/company/quality/kqp')}
                  >
                    Cancel
                  </Button>
                  {action === 'create' ? (
