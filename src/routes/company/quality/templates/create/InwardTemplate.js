        ...
        <Col span={24} className="gx-pt-4">
          ...
          <Row>
            ...
            <Col span={8}>
              <div style={{ display: "grid", marginTop: 45 }}>
                {props.action === "view" &&
                  props.templateDetails.coilBendPreSingedURL && (
                    <img
                      alt=""
                      src={props.templateDetails.coilBendPreSingedURL}
                      style={{ width: 50 }}
                    />
                  )}
                {props.action === "edit" && (
          ...
          <Row>
            ...
            <Col span={8}>
              <div style={{ display: "grid", marginTop: 45 }}>
                {props.action === "view" &&
                  props.templateDetails.waterExposurePreSingedURL && (
                    <img
                      src={props.templateDetails.waterExposurePreSingedURL}
                      alt="Forest"
                      style={{ width: 50 }}
                    />
                  )}
          ...
          <Row>
            ...
            <Col span={8}>
              <div style={{ display: "grid", marginTop: 45 }}>
                {props.action === "view" &&
                  props.templateDetails.wireRopeDamagesPreSingedURL && (
                    <img
                      src={props.templateDetails.wireRopeDamagesPreSingedURL}
                      alt="Forest"
                      style={{ width: 50 }}
                    />
                  )}
