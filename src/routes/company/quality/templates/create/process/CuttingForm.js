        ...
        <Card.Grid style={gridCardStyle}>
          <Row>
            <Col span={24}>
              ...
              <Input
                ...
                disabled
                value={cutFormData.customerName}
          ...
          <Row>
            <Col span={24}>
              ...
              <Input
                disabled
                value={cutFormData.physicalAppearance}
        ...
        <Card.Grid style={gridCardStyle}>
          ...
          <Row>
            <Col span={12}>
              ...
              <Input
                disabled
                value={cutFormData.motherCoilNumber}
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={cutFormData.aspenCoilNumber}
        ...
        <Card.Grid style={gridStyle}>
          <Row>
            <Col span={24}>
              ...
              <TextArea
                value={cutFormData.finalJudgement}
          ...
          <Row>
            <Col span={12}>
              ...
              <Input
                value={cutFormData.qualityEngineer}
