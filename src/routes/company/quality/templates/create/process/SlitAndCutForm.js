...
const SlitAndCutForm = props => {
  ...
  }, [props.templateDetails.operation, viewCutTolerance]);
  ...
  const viewSlitTolerance = () => {
    if (props.templateDetails.operation == 'templateById') {
      var templateId = props.templateDetails.data.templateId;
      props.getQualityTemplateById(templateId);
      const slitDetails = JSON.parse(
        props.templateDetails.data.templateDetails,
      );
      const toleranceDataTable =
        slitDetails[5]?.value.toleranceInspectionDataSlit;
      const toleranceData = toleranceDataTable.map((item, i) => ({
        toleranceThicknessFrom: item.toleranceThicknessFrom,
        toleranceThicknessTo: item.toleranceThicknessTo,
  ...
  }, [props.templateDetails.operation, viewSlitTolerance]);
        ...
        <Card.Grid style={gridCardStyle}>
          <Row>
            <Col span={24}>
              ...
              <Input
                ...
                disabled
                value={slitCutFormData.customerName}
          ...
          <Row>
            <Col span={12}>
              ...
              <DatePicker
                disabled
                value={slitCutFormData.processDate}
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitCutFormData.batchNumber}
          ...
          <Row>
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitCutFormData.thickness}
          ...
          <Row>
            <Col span={24}>
              ...
              <Input
                disabled
                value={slitCutFormData.physicalAppearance}
        ...
        <Card.Grid style={gridCardStyle}>
          <Row>
            <Col span={24}>
              ...
              <Input
                disabled
                value={slitCutFormData.operation}
          ...
          <Row>
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitCutFormData.motherCoilNumber}
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitCutFormData.aspenCoilNumber}
          ...
          <Row>
            <Col span={24}>
              ...
              <DatePicker
                style={{ width: '100%' }}
                disabled
                value={slitCutFormData.reportDate}
        ...
        <Card.Grid style={gridStyle}>
          <Row>
            <Col span={24}>
              ...
              <TextArea
                value={slitCutFormData.finalJudgement}
          ...
          <Row>
            <Col span={12}>
              ...
              <Input
                value={slitCutFormData.qualityEngineer}
            ...
            <Col span={12}>
              ...
              <Input
                value={slitCutFormData.qualityHead}
