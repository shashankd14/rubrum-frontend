        ...
        <Card.Grid style={gridCardStyle}>
          <Row>
            <Col span={24}>
              ...
              <Input
                disabled
                value={slitFormData.customerName}
          ...
          <Row>
            <Col span={12}>
              ...
              <DatePicker
                disabled
                value={slitFormData.processDate}
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitFormData.batchNumber}
        ...
        <Card.Grid style={gridCardStyle}>
          ...
          <Row>
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitFormData.motherCoilNumber}
            ...
            <Col span={12}>
              ...
              <Input
                disabled
                value={slitFormData.aspenCoilNumber}
