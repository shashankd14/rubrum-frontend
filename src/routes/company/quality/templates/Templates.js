    ...
    render: (text, record) => (
        <span>
            ...
            <span
                className="gx-link"
                onClick={() =>
                    props.deleteQualityTemplate(record.templateId, record.requestId="deleteTemplate")
                }
            >
                Delete
            </span>
  ...
  render: (text, record) => (
      <span>
          ...
          <span
              className="gx-link"
              onClick={() =>
                  props.deleteQualityTemplateLink(record.templateId, record.requestId="deleteTemplateLink")
              }
          >
              Delete
          </span>
