      ...
      <Col span={24} className="gx-pt-4">
        ...
        <Row>
          <Col span={8}>
            <div style={{ display: "grid", marginTop: 15 }}>
              {props.action === "view" &&
                props.templateDetails.processingReport1URL && (
                  <img
                    src={props.templateDetails.processingReport1URL}
                    alt="ProcessingReport"
                    style={{ width: 50 }}
                  />
                )}
              {props.action === "edit" && (
        ...
        <Row>
          <Col span={8}>
            <div style={{ display: "grid", marginTop: 15 }}>
              {props.action === "view" &&
                props.templateDetails.processingReport2URL && (
                  <img
                    src={props.templateDetails.processingReport2URL}
                    alt="ProcessingReport"
                    style={{ width: 50 }}
                  />
                )}
        ...
        <Row>
          <Col span={8}>
            <div style={{ display: "grid", marginTop: 15 }}>
              {props.action === "view" &&
                props.templateDetails.processingReport3URL && (
                  <img
                    src={props.templateDetails.processingReport3URL}
                    alt="ProcessingReport"
                    style={{ width: 50 }}
                  />
                )}
              {props.action === "edit" && (
                <>
                  ...
                  {props.templateDetails.processingReport3URL && (
                    <img
                      src={props.templateDetails.processingReport31URL}
                      alt="ProcessingReport"
                      style={{ width: 50 }}
                    />
                  )}
        ...
        <Row>
          <Col span={8}>
            <div style={{ display: "grid", marginTop: 15 }}>
              {props.action === "view" &&
                props.templateDetails.processingReport4URL && (
                  <img
                    src={props.templateDetails.processingReport4URL}
                    alt="ProcessingReport"
                    style={{ width: 50 }}
                  />
                )}
