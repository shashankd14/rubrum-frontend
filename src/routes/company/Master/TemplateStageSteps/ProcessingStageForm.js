    ...
    <>
      <Col span={18} className="login-form gx-pt-4">
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          <div style={{ width: '50%' }}>
            <CreateForm
              formFields={props.slitFields}
              setFields={setSlitFields}
              btnName="Slit Parameters"
            />
          </div>
          <div style={{ width: '50%' }}>
            <CreateForm
              formFields={props.cutFields}
              setFields={setCutFields}
              btnName="Cut Parameters"
            />
          </div>
        </div>
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          <Card
            style={{ display: 'flex', minHeight: '40vh', width: '50%' }}
            className="gx-card"
          >
            <Row>
              <Col
                          ...
                          inputEle = (
                            <Radio.Group value={field.value}>
                              {options.map((item, index) => (
                                <Radio value={camelCase(item)} key={index}>
                                  {item}
                                </Radio>
                              ))}
                            </Radio.Group>
