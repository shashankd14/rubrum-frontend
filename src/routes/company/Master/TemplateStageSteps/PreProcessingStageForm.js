    ...
    <>
      <Col span={18} className="login-form gx-pt-4">
        ...
        <Button
          ...
          style={{ float: 'right' }}
          onClick={() => {
            dispatch(createFormFields(fields, 'preProcessing'));
            props.updateStep(2);
          }}
        >
          Forward
...
const mapStateToProps = state => ({
  formFields: state.quality.formFields?.preProcessing || [],
});

export default connect(mapStateToProps)(PreProcessingStageForm);
