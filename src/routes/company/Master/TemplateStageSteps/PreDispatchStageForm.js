...
const PreDispatchStageForm = props => {
    ...
    <>
      <Col span={18} className="login-form gx-pt-4">
                  ...
                  {fields &&
                    fields?.map((field, index) => {
                      ...
                      if (field.type === 'calendar') {
                        ...
                        inputEle = (
                          <Input type={field.type} value={field.value}></Input>
                        );
                      }
                      return (
                        <FormItem
        ...
        <Button
          ...
          style={{ float: 'right' }}
          onClick={() => {
            dispatch(createFormFields(fields, 'preDispatch'));
            props.updateStep(4);
          }}
        >
          Forward
...
const mapStateToProps = state => ({
  formFields: state.quality.formFields?.preDispatch || [],
});

export default connect(mapStateToProps)(PreDispatchStageForm);
