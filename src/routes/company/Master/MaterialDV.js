...
import {Button, Card, Divider, Table, Modal, Row, Col, Form, Input, Checkbox, Select} from "antd";
                    ...
                    <Card className="gx-card">
                            ...
                            <Col lg={24} md={24} sm={24} xs={24} className="gx-align-self-center">
                                    ...
                                    <Col className='add-category-button'>
                                        {getFieldDecorator('mainCategory', {
                                            ...
                                            <Input id="mainCategory" {...getFieldProps} style={{ marginRight: '8px' }}/>
                                        )}
                                         <Button type='primary' htmlType="submit" onClick={()=> setAddMainCategory(true)}>
                                            Add
                                        </Button>
                                        <Modal
                                    ...
                                    <Form.Item label="Item sub category" >
                                        ...
                                        {getFieldDecorator('subCategory', {
                                            ...
                                            <Input id="subCategory" {...getFieldProps} style={{ marginRight: '8px' }}/>
                                        )}
                                        <Button type="primary"
                                        onClick={() => {
                                            props.form.resetFields();
                        ...
                        <Row>
                         ...
                         <Col className='flex-row'>
                          ...
                          <Col className='flex-row' style={{marginRight:'-40px'}}>
                           ...
                           <label className='left-side-label' style={{marginRight:'-40px'}}>Guage</label>
                          </Col>
                          </Form.Item>
                        </Row>
                        ...
                        <Col lg={6} md={6} sm={12} xs={12}  className="gx-align-self-center">
                            ...
                            <Checkbox 
                                ...
                                <Input placeholder='Enter parameter name' {...getFieldProps} style={{marginRight: '-70px', marginLeft: '8px'}} />
                            </Form.Item>
                         </Col>
                         ...
                         <Form.Item>
                          <Col className='flex-row-mm'>
                           ...
                           <label className='left-side-label-mm'>Inches</label>
                            ...
                            <Button type='primary' htmlType='submit' icon='plus'>Add Parameter</Button>
                        ...
                        <Form.Item>
                        <Col style={{ display: 'flex'}} lg={24} md={24} sm={24} xs={24}>
                            <Col lg={12} md={12} sm={24} xs={24}>
                        ...
                        <Col lg={24} md={24} sm={24} xs={24}  className="gx-align-self-center">
                         <Form.Item >
                            ...
                            <Col style={{display: 'flex', flexDirection:'row'}}>
                                ...
                                <label className='left-side-label' style={{marginRight: '-40px'}}>kg per meter</label>
                            </Col>
                            </Form.Item>
