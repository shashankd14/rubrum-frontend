...
const List = (props) => {
  ...
  return (
    <div>
      <h1>
        <IntlMessages id="sidebar.company.stockRegisterList" />
      </h1>
      <Card>
        <div className="gx-flex-row gx-flex-1">
          <div className="table-operations gx-col">
            ...
            >
              <Select.Option value="addInward">Add Inward</Select.Option>
              <Select.Option value="generateQuote">Generate Quote</Select.Option>
              <Select.Option value="addPI">Generate Proforma Invoice</Select.Option>
              <Select.Option value="generateDeliveryOrder">Generate Delivery Order</Select.Option>
            </Select>&emsp;
           ...
           {/* {menuPartyWiseLabelList.length > 0 && menuPartyWiseLabelList.includes(partyWiseMenuConstants.deliver) && <Button
            ...
            <SearchBox
              styleName="gx-flex-1"
              placeholder="Search for item or item code..."
              value={searchValue}
