...
const Plan = props => {
  ...
  useEffect(() => {
    if (
      props.inward.plan?.instruction?.length !==
        slittingCoil?.instruction?.length &&
      props.inward.isDeleted
    ) {
    ...
    >
      {cuttingCoil && (
        <CuttingModal
          ...
          coilDetails={cuttingCoil}
          wip={props.wip}
          childCoil={childCoil}
          plannedLength={getPlannedLength}
          plannedWidth={getPlannedWidth}
      ...
      {slittingCoil && (
        <SlittingModal
          showSlittingModal={showSlittingModal}
          setShowSlittingModal={setShowSlittingModal}
          wip={props.wip}
          coilDetails={slittingCoil}
          childCoil={childCoil}
          plannedLength={getPlannedLength}
          plannedWidth={getPlannedWidth}
          plannedWeight={getPlannedWeight}
      ...
      <h1>
        <IntlMessages id="partywise.plan.label" />
      </h1>
      {reconcileModalShow?.length > 0 && (
        <>
          <div>
      ...
      <div className="gx-full-height gx-flex-row">
          ...
          <Card className="gx-plan-main-coil" size="small">
            ...
            <div className="gx-flex-row">
              ...
              <span className="gx-coil-details-label">
                {props.inward.plan.availableLength}
              </span>
            </div>
            <div className="gx-flex-row">
              <p className="gx-coil-details-label">
            ...
            {props.wip ? (
              <div>
                {props.inward.plan.fpresent !== 0 ? (
                  <Button onClick={() => setshowUnprocessedModal(true)}>
                    Unprocessed
                  </Button>
                ) : (
                  <></>
        ...
        <Col
          ...
          xs={24}
          offset={1}
          className="gx-align-self-center gx-branch lv1"
        >
          {instruction &&
                            ...
                            {instruction.groupId == null ? (
                              <div style={{ display: 'flex' }}>
                                <Col
                                  ...
                                  xs={24}
                                  offset={1}
                                  className={`gx-align-self-center cardLevel2Div ${instruction.parentGroupId == null ? (group[0].process.processId === 1 ? 'gx-cutting-group' : instruction.process.processId === 7 ? 'gx-unprocessed-group' : 'gx-slitting-group') : 'gx-slit-cut-group'}`}
                                >
                                  <Card
                                    key={`${props.inward.plan.coilNumber}${instruction.instructionId}`}
                                    className={`cardLevel2InsideDiv ${instruction.parentGroupId == null ? (instruction.process.processId === 1 ? 'gx-cutting-single' : instruction.process.processId === 7 ? 'gx-unprocessed-single' : 'gx-slitting-single') : 'gx-slit-cut-single'}`}
                                    size="small"
                                  >
                                    <img
                                      style={{
                                    ...
                                    <div style={{ marginLeft: '8px' }}>
                                      ...
                                      <div className="gx-flex-row">
                                        ...
                                        <span className="gx-coil-details-label">
                                          {props.inward.plan.fThickness}X
                                          {getPlannedWidth(instruction)}X
                                          {instruction?.deliveryDetails !==
                                            null &&
                                          instruction?.deliveryDetails
                                            ?.deliveryId !== null
                                            ? 0
                                            : getPlannedLength(instruction)}
                                          /
                                          {instruction?.deliveryDetails !==
                                            null &&
                                          instruction?.deliveryDetails
                                ...
                                {instruction.childInstructions?.length > 0 ? (
                                  <Col
                                    ...
                                    xs={24}
                                    offset={1}
                                    className="gx-align-self-center gx-branch-lvl2"
                                  >
                                    <>
                                      <Col
                                        lg={24}
                                        ...
                                        xs={24}
                                        offset={1}
                                        className={`gx-align-self-center cardLevel2Div ${instruction.childInstructions[0].process.processId === 1 ? 'gx-cutting-group' : instruction.process.processId === 7 ? 'gx-unprocessed-group' : 'gx-slitting-group'}`}
                                      >
                                        <Card
                                          key={`${props.inward.plan.coilNumber}${instruction.instructionId}`}
                                          className={`cardLevel2InsideDiv ${instruction.childInstructions[0].process.processId === 1 ? 'gx-cutting-single' : instruction.process.processId === 7 ? 'gx-unprocessed-single' : 'gx-slitting-single'}`}
                                          size="small"
                                        >
                                          <img
                                            style={{
                                ...
                                ) : instruction.deliveryDetails !== null &&
                                  instruction.deliveryDetails.deliveryId !==
                                    null ? (
                                  <Col
                                    lg={7}
                                    md={7}
                                  ...
                                  >
                                    <>
                                      <Col
                                        ...
                                        sm={24}
                                        xs={24}
                                        className="gx-align-self-center plan-dl-box"
                                      >
                                        <Card
                                          key={`${props.inward.plan.coilNumber}${instruction.instructionId}`}
                                          className="cardLevel2InsideDiv gx-delivery-single"
                                          size="small"
                                        >
                                          <img
                                            style={{
