...
const PartyWise = ({match}) => (
    <Switch>
        ...
        <Route path={`${match.url}/unfinish/:coilNumber`} component={props => <Unfinish {...props} unfinish />} />
        <Route path={`${match.url}/editFinish/:coilNumber`} component={props => <Unfinish {...props} editFinish />} />
